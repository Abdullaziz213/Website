    ...
    return (
        <div className='max-w-[1200px] mx-auto flex flex-col lg:flex-row text-white/70 p-8
            ...
            <div className='flex justify-center items-center'>
                <ul className='space-y-4'>
                    <li className='flex items-center'>
                        ...
                        <p className='text-xl'>+41 76 784 77 23</p>
                    </li>
                    <li className='flex items-center'>
                        <Image src={mail} alt="mail" className='h-[110px] w-auto mr-6'/>
                        <p className='text-xl'>abdullaziz.hassenabdella@ksb-sg.ch</p>
                    </li>
                </ul>
            </div>
            ...
            <div className='bg-white/10 p-6 rounded-xl max-w-[550px]'>
                ...
                <form className='space-y-4' action="https://getform.io/f/blljvodb" method='POST'>
                    <div className='grid md:grid-cols-2 gap-4'>
                        ...
                        <input type='email' name='email' className='bg-black/70 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400' placeholder='E-Mail'/>

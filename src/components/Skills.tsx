...
import { FaHtml5, FaCss3Alt, FaReact, FaJsSquare, FaJava, FaPython, FaJsfiddle, FaDatabase, FaCode, FaNodeJs,} from 'react-icons/fa';
    ...
    return (
        <div className='bg-[linear-gradient(to_top,#000,#381a5f_80%)] py-32'>
            <div className='text-white w-[400px] md:min-w-[950px] mx-auto p-8 text-center'>
                <h2 className='text-6xl font-bold mb-4'>What I can do</h2>
